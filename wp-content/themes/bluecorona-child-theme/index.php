...
?>
<main>
	<div class="container-fluid sub_banner" style="height:230px; background-size: 100%; background-position: top; background-repeat: no-repeat; background-image: url('<?php echo get_stylesheet_directory_uri();?>/img/sub_banner.jpg');">
