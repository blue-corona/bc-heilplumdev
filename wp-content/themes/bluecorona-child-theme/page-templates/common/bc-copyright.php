...
<?php echo bc_get_theme_mod('bc_theme_options', 'footer','copyright_text', '<div class="bc_color_quaternary container border-top py-4 py-lg-2  font-uppercase bc_text_18 bc_line_height_60 bc_sm_text_18 text-uppercase bc_sm_line_height_18" style="border-color:  #999999 !important;">
  ...
  <span class=" d-lg-inline-block d-none">&nbsp; | &nbsp;</span><br class="d-block d-lg-none"><a class="bc_text_18 bc_line_height_60 bc_color_quaternary_hover bc_sm_text_18 bc_sm_line_height_18 text-uppercase font-uppercase bc_color_quaternary no_hover_underline" href="'.get_home_url().'/privacy-policy'.'">Privacy Policy</a>
...
<button data-toggle="modal" data-target="#myModal_mobile" class="btn btn-lg w-100 d-block d-lg-none bc_color_secondary  bc_color_primary_bg  position-fixed sticky-footer bc_font_alt_1 bc_text_bold  bc_text_22 bc_line_height_72 p-0 border-0" style="bottom: 0; z-index:999; font-weight: 600 !important; position: fixed !important; border-radius: 0px !important;"> How Can We Help?<span> &nbsp; <i class="fal fa-chevron-up bc_text_24"></i></span></button>
