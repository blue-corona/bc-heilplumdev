                    ...
                    <div class="hero_banner_form rounded overflow-hidden bc_color_white_bg">
                        ...
                        <div class="row">
                           <div class="col-12 px-5">
                                <span class="bc_text_28 bc_line_height_27 bc_font_alt_1 bc_text_bold bc_color_3 d-block mt-3 bc_hero_form_title_text"> How Can We Help?</span>
...
<script>
	...
	if(form_id == 1){
		jQuery(".bc_hero_form_title_text").html("Thank you!");
	}
    });
</script>
<!-- for mobile -->
