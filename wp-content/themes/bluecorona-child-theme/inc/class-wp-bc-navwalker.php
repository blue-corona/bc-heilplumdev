...
if ( ! class_exists( 'Bluecorona_WP_Bootstrap_Navwalker' ) ) {
	/**
	 * WP_Bootstrap_Navwalker class.
	 *
	 * @extends Walker_Nav_Menu
	 */
	class Bluecorona_WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if ( isset( $args->has_children ) && $args->has_children && $args->depth > 1 ) {
				...
				if ( $depth > 0 ) {
					$atts['class'] = 'dropdown-item mx-0 px-0 px-lg-2';
				} else {
			...
			$icon_html = '';
			if ( isset( $args->has_children ) && $args->has_children && $args->depth > 1 ) {
				$icon_html = '&nbsp;<span class="float-right bc-nav-dropdown-icon float-lg-none pr-3 pr-lg-0"><i class="far fa-chevron-down" aria-hidden="true"></i><span> ';
			} else {
