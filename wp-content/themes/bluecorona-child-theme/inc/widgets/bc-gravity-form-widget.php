...
class BC_Gravity_Widget extends WP_Widget {
	...
	<div class="bc_color_primary_bg pt-2 pb-4 text-center d-none d-md-block" style="border-radius: 10px;">
        <span class="bc_text_28 bc_font_alt_1 bc_color_secondary  bc_text_bold bc_line_height_72 bc_sidebar_form_title">
	    	<?php 
